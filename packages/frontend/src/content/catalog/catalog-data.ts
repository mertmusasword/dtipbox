...
const catalogTR: CatalogContent = {
  ...
  slide1: {
    ...
    confidential: 'NAPONI TECHNOLOGIES INC. • GİZLİ VE TİCARİDİR',
  ...
  slide4: {
    ...
    subtitle: 'Sıradan kağıt çıktılar değil; restoran ve otelinizin mimarisine özel yüksek kaliteli fiziksel temas noktaları.',
    card1Tag: 'Akrilik Masa Standı',
    card1Title: 'Akrilik Pleksi & Ahşap Standlar',
    card1Desc: 'Masa numaralarına özel üretilen, suya ve güneş ışığına dayanıklı, çizilmez lüks masaüstü blokları.',
    card2Tag: 'Manyetik Yaka Rozeti',
    card2Title: 'Akıllı Garson & Vale Rozetleri',
    card2Desc: 'Barmen, vale ve hareket halindeki servis ekibi için kıyafete zarar vermeyen manyetik ve şık QR rozetler.',
    card3Tag: 'Adisyon İçi Kart',
    card3Title: 'Adisyon Deri Folyo Kartları',
    card3Desc: 'Hesap sümeninin içine yerleştirilen kartlar sayesinde müşteri hesabı incelerken konforlu ve özel bir şekilde bahşiş bırakır.',
    footer: 'NAPONI TOUCHPOINT EKİPMANLARI • 300 DPI VEKTÖREL BASKI UYUMLU',
  ...
  slide9: {
    ...
    step3Desc: 'Akrilik standlarınızı veya adisyon kartlarınızı masalara yerleştirin. İlk günden bahşiş gelirlerinizin artışını canlı panelden izleyin.',
    ...
    badge3Val: '7/24 Teknik Destek',
    badge3Desc: 'İşletmenize özel kurumsal müşteri temsilcisi',
  ...
  slide10: {
    ...
    footer: '© 2026 NAPONI TECHNOLOGIES INC. • HER HAKKI SAKLIDIR.',
...
const catalogEN: CatalogContent = {
  ...
  slide1: {
    ...
    confidential: 'NAPONI TECHNOLOGIES INC. • CONFIDENTIAL & PROPRIETARY',
  ...
  slide4: {
    tag: 'Venue Aesthetics',
    title: 'Touches Worthy of Your Venue\'s Prestige',
    subtitle: 'Not generic paper printouts: luxury, architectural physical touchpoints custom-tailored to high-end hospitality.',
    card1Tag: 'Acrylic Table Block',
    card1Title: 'Acrylic Glass & Wood Stands',
    card1Desc: 'Produced with custom table numbers, water-resistant, UV-proof, scratch-resistant luxury desktop touchpoints.',
    card2Tag: 'Magnetic Staff Badge',
    card2Title: 'Smart Server & Valet Badges',
    card2Desc: 'Premium magnetic QR badges that clip gently to uniforms for bartenders, valets, and mobile service personnel.',
    card3Tag: 'Check Folder Insert',
    card3Title: 'Leather Bill Folder Cards',
    card3Desc: 'Elegantly placed inside leather check presentation folders, allowing guests to review the bill and tip discreetly.',
    footer: 'NAPONI TOUCHPOINT HARDWARE • 300 DPI VECTOR READY',
  ...
  slide9: {
    ...
    step3Desc: 'Place acrylic stands or bill folder cards on tables. Monitor real-time tip growth from day one on your executive dashboard.',
    ...
    badge3Val: '24/7 Dedicated Support',
    badge3Desc: 'Dedicated corporate account manager for your venue',
  ...
  slide10: {
    ...
    footer: '© 2026 NAPONI TECHNOLOGIES INC. • ALL RIGHTS RESERVED.',
